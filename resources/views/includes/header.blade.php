  ...
  <div class="container-fluid">
    <nav class="navbar navbar-expand-lg">
      <a class="navbar-brand logo" href="#">
        <img style="width: 90px;" src="/images/logo.svg" alt="">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link tele" href="#">
              <img style="width: 30px;" src="/images/tele.svg" alt="">
              <span>Телеграм бот</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link pod" href="{{ route('ask-question') }}">
  ...
  <img style="width: 49px;" src="/public/images/ava.svg" alt="">
  </button>
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
  <a class="dropdown-item" href="{{ route('tickets-list') }}">{{ Lang::get('profile') }}</a>
      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse mt-2" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a href="{{ route('ask-question') }}" class="nav-link btn pdBtn text-white">Написать в поддержку</a>
            </li>
          </ul>
          @if (auth()->check())
