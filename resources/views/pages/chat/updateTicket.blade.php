                        ...
                        <div id="first_block">
                            ...
                            <div class="form-check mt-3">
                                <label class="form-check-label formLabel" for="service_types_id_{{ $service_type->id }}">
                                    <input value="{{ $service_type->id }}" class="form-check-input PodsInput" type="radio" name="service_types_id" id="service_types_id_{{ $service_type->id }}" @if ($my_ticket->service_types_id == $service_type->id)
                                    checked
                                    @endif>
                            ...
                            <div style="margin-top: 79px;" class="d-flex mb-lg-4">
                                <button id="write_text_button" type="button" class="btn btn-primary btn-lg" onclick="toggle_blocks()">{{Lang::get("Write request")}}</button>
                            </div>
                        </div>
                        {{-- First page END --}}
                        {{-- Second page --}}
                                ...
                                <div class="col-6">
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        <div class="form-outline flex-fill mb-0 w-100">
                                            ...
                                            @if ($user)
                                            <input type="text" value="{{ $user->name }}" id="ask_name" name="name form-label" class="form-control myInput" required readonly />
                                            @else
                                            <input type="text" id="ask_name" name="name" class="form-control myInput form-label" required />
                                            @endif
                                        </div>
                                    </div>
                                </div>
