                ...
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <div class="account myLine">
                            <p class="mb-5" style="color: #CCCCCC; font-size: 24px;">Аккаунт</p>
                        </div>
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="profile_img">
                                    <img style="width: 100px" src="/images/profileAva.svg" alt="" />
                                </div>
                            </div>
                            <div class="col-lg-3">
                    ...
                    <div class="col-md-8 col-sm-12">
                        <div class="account myLine">
                            <p class="mb-5" style="color: #CCCCCC; font-size: 24px;">Профиль</p>
                        </div>
                        <div class="row">
                            <div class="col-lg-1">
                            </div>
                            <div style="margin-left: 29px;" class="col-lg-6">
                                <table class="profile_table">
                                    ...
                                    <tr>
                                        <td style="text-align:right">Привязка к организации:</td>
